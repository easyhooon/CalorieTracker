...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (calorieGoal * userInfo.carbRatio / 4f).roundToInt() // 1g 4kcal
        val proteinGoal = (calorieGoal * userInfo.proteinRatio / 4f).roundToInt() // 1g 4kcal
        val fatGoal = (calorieGoal * userInfo.fatRatio / 9f).roundToInt() // 1g 9kcal
